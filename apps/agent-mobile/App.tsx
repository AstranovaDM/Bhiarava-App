  ...
  return (
    <NavigationContainer>
      ...
      <Tab.Navigator>
        ...
        <Tab.Screen name="Leads" children={() => <ListScreen title="Leads" />} />
        <Tab.Screen name="Visits" children={() => <ListScreen title="Visits" />} />
        <Tab.Screen name="More" children={() => <ListScreen title="More" />} />
      </Tab.Navigator>
    </NavigationContainer>
  );
}
